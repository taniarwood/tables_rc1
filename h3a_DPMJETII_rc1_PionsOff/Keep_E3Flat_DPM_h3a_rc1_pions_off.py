...
#####################################################################
	...
	eedges = np.logspace(-0.4, 3.2, 301)
...
#	directory = '/home/trwood/tables_rc1/DPMJETIII_h3a_rc1/tables/'
	#directory = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/DPMJETIII_h3a_rc1/tables/'
       	directory = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/h3a_DPMJETII_rc1_PionsOff/'
	...
	self.spline_scaling_factorE = 0.020
        ...
        self.spline_dict = {'nue' :self.LoadData(directory + "egrid.txt", directory + "cos_zenith_grid.txt", directory + "nue_totals_pions_off.txt"),
