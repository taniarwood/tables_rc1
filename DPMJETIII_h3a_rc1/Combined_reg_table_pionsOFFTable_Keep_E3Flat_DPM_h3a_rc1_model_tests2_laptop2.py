...
#easer to fit in flux*E^3 space instead of flux.. but that will make calculating nu-oscillations difficult.  Ask JP again?
	...
	directory = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/model_tests/tables_rc1_albrecht_v2/'+ pmod + '_' + intmod + str(".regular/") #'/home/trwood/tables_rc1/DPMJETIII_h3a_rc1/tables/'
	directory_p = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/model_tests/tables_rc1_albrecht_v2/'+ pmod + '_' + intmod + str("/")
