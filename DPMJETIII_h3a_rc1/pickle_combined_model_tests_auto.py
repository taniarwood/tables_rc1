...
#    print 'Stuff', np.sum(data['weight_DMP_h3a_rc1_e_k']+data['weight_DMP_h3a_rc1_e_k']), (data['weight_DMP_h3a_rc1_e_k']+data['weight_DMP_h3a_rc1_e_p']).mean(), (data['weight_DMP_h3a_rc1_e_k']+ data['weight_DMP_h3a_rc1_e_k']).max(),  (data['weight_DMP_h3a_rc1_e_k']+ data['weight_DMP_h3a_rc1_e_k']).min()
    print '                                                            '
...
#    combinedmu = np.sum(data['weight_DMP_h3a_rc1_flat_mu_k']) + np.sum( data['weight_DMP_h3a_rc1_flat_mu_p'])
 ...
 #   print 'Stuff', combinedmu, (data['weight_DMP_h3a_rc1_mu_k'] + data['weight_DMP_h3a_rc1_mu_p']).mean(), (data['weight_DMP_h3a_rc1_mu_k'] + data['weight_DMP_h3a_rc1_mu_p']).max(), (data['weight_DMP_h3a_rc1_mu_k'] + data['weight_DMP_h3a_rc1_mu_p']).min()
