...
indir = '/gs/project/ngw-282-ac/trwood/jasper_home/MSU_contain_removed/flat_tania3_DPM_interm_BAKOct12017_jaspert_BKBK/flat_tania3_jaspert2344/'
#indir     = '/home/trwood/MSU_contain_removed/flat_tania3'
...
e_weights = ['tweight_DMP_h3a_rc1_flat_e_jaspert',  'tweight_DMP_h3a_rc1_e_jaspert', 'weight_e']
#e_weights = ['tweight_newflat_e', 'tweight_e']

	      #tweight_DMP_h3a_rc1_flat_mu_k_jaspert'
mu_weights = ['tweight_DMP_h3a_rc1_flat_mu_k_jaspert', 'tweight_DMP_h3a_rc1_flat_mu_p_jaspert', 'tweight_DMP_h3a_rc1_mu_k_jaspert', 'tweight_DMP_h3a_rc1_mu_p_jaspert','weight_mu']
