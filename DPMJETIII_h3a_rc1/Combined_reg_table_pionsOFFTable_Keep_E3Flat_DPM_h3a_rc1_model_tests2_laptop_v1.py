...
#easer to fit in flux*E^3 space instead of flux.. but that will make calculating nu-oscillations difficult.  Ask JP again?
    ...
    def __init__(self, intmodel='H3a', pmodel='DPMJET-III'):
        ...
        '''#H3a_DPMJET-III  so intmod, then pmod. opps. flipped them
        intmod =  intmodel
	pmod = pmodel 
                    #/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/DPMJETIII_h3a_rc1
	directory = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/model_tests/tables_rc1_albrecht/'+ intmod + '_' + pmod + str(".regular/") #'/home/trwood/tables_rc1/DPMJETIII_h3a_rc1/tables/'
	directory_p = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/model_tests/tables_rc1_albrecht/'+ intmod + '_' + pmod + str("/")
...
#	directory = '/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/DPMJETIII_h3a_rc1/tables/'
	...
	dir_grid ='/Users/trwood/Downloads/downloaded_notebokos/tables_rc1/model_tests/tables_rc1_albrecht/communial/' #'cos_zenith_grid_modeltests.txt  egrid.txt
        print directory
        print directory_p	
	#global data members
