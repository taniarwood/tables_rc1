...
for zii, zenith in enumerate(angles):
    ...
    if pmodel[1] == None:
	file_paths = desktop+"/tables_rc1_albrecht/GSF_"+intmodel+"/numu_totals.txt"
    else:
...
#file_paths ='/Users/trwood/my/franks2/file2.txt'
 ...
 #  try:
  ...
  #      print "handle error"
    if pmodel[1] == None:
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/GSF_"+intmodel, 'numu_totals.txt'),'w'),modelname_numu)
    	np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/GSF_"+intmodel, 'antinumu_totals.txt'),'w'),modelname_antinumu)
    	np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/GSF_"+intmodel, 'nue_totals.txt'),'w'),modelname_nue)
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/GSF_"+intmodel, 'antinue_totals.txt'),'w'),modelname_antinue)
     
    else:
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/"+pmodel[1]+"_"+intmodel, 'numu_totals.txt'),'w'),modelname_numu)
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/"+pmodel[1]+"_"+intmodel, 'antinumu_totals.txt'),'w'),modelname_antinumu)
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/"+pmodel[1]+"_"+intmodel, 'nue_totals.txt'),'w'),modelname_nue)
        np.savetxt(open(os.path.join(desktop+"/tables_rc1_albrecht/"+pmodel[1]+"_"+intmodel, 'antinue_totals.txt'),'w'),modelname_antinue)
